...
function loadTimesheet() {
	...
	document.getElementById('employeedashboard-frame').style.display = 'none';
}

function loademployeedashboard() {
    var iframe = document.getElementById('employeedashboard-frame');
    iframe.src = 'employeedashboard.html';  // Make sure this file exists
